...
list = ['GGBR4.SA', 'BBDC4.SA','EMBR3.SA', 'BOVA11.SA']
...
print('peso otimo(w) = ', outcome['x'].round(9)) # numero 6 é referente ao aerredondamento de 6 casas decimais
print('+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
print('')

#fig.show()

# +++++++++++++++++++++++++++++++++++++++++++++++++++++( PONTO OTIMI - MINIMA VOLATILIDADE) ++++++++++++++++++++++++++++++++++++++++++++++++++++#
